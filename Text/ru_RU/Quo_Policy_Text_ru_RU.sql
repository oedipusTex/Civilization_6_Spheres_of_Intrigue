...
-- SURVEY
UPDATE LocalizedText SET Text='Поселенцы и разведчики не получают штраф за прохождение мимо врагов и через реки. Удваивается опыт от разведки.' WHERE Tag='LOC_POLICY_SURVEY_DESCRIPTION' ;


-- URBAN PLANNING
UPDATE LocalizedText SET Text=Text || ' +100% к [ICON_PRODUCTION] строительству амбаров.' WHERE Tag='LOC_POLICY_URBAN_PLANNING_DESCRIPTION' ;


-- INSULAE (Housing 1), MEDINA QUARTER (Housing 2)
UPDATE LocalizedText SET Text=' +1 к [ICON_HOUSING] жилью во всех городах.' WHERE Tag='LOC_POLICY_INSULAE_DESCRIPTION' ;
UPDATE LocalizedText SET Text=' +2 к [ICON_HOUSING] жилью во всех городах.' WHERE Tag='LOC_POLICY_MEDINA_QUARTER_DESCRIPTION' ;


UPDATE LocalizedText SET Text='[ICON_HOUSING] 1 единица жилья (Инсулы)' WHERE Tag='LOC_POLICY_INSULAE_NAME' ;
UPDATE LocalizedText SET Text='[ICON_HOUSING] 2 единицы жилья (Квартал Медины)' WHERE Tag='LOC_POLICY_MEDINA_QUARTER_NAME' ;


-- NEW DEAL
UPDATE LocalizedText SET Text='+4 к [ICON_Housing] жилью, +2 к [ICON_Amenities] довольству, -8 к [ICON_Gold] золоту во всех городах.' WHERE Tag='LOC_POLICY_NEW_DEAL_DESCRIPTION' ;


-- CORVEE, GOTHIC ARCHITECTURE, SKYSCRAPERS
UPDATE LocalizedText SET Text='+30% к [ICON_Production] производству чудес света Древнего мира и эпохи Античности.' WHERE Tag='LOC_POLICY_CORVEE_DESCRIPTION' ;
UPDATE LocalizedText SET Text='+30% к [ICON_Production] производству чудес света Древнего мира, Античности и эпохи Средневековья.' WHERE Tag='LOC_POLICY_GOTHIC_ARCHITECTURE_DESCRIPTION' ;
UPDATE LocalizedText SET Text='+30% к [ICON_Production] производству чудес света любой эпохи.' WHERE Tag='LOC_POLICY_SKYSCRAPERS_DESCRIPTION' ;


UPDATE LocalizedText SET Text='[ICON_Production][ICON_TOURISM] Чудеса 1 (Барщина)' WHERE Tag='LOC_POLICY_CORVEE_NAME' ;
UPDATE LocalizedText SET Text='[ICON_Production][ICON_TOURISM] Чудеса 2 (Готическая Архитектура)' WHERE Tag='LOC_POLICY_GOTHIC_ARCHITECTURE_NAME' ;
UPDATE LocalizedText SET Text='[ICON_Production][ICON_TOURISM] Чудеса 3 (Небоскребы)' WHERE Tag='LOC_POLICY_SKYSCRAPERS_NAME' ;


-- VETERANCY
UPDATE LocalizedText SET Text='+100% к [ICON_PRODUCTION] производству военных лагерей и зданий внутри них.' WHERE Tag='LOC_POLICY_VETERANCY_DESCRIPTION' ;


-- COLONIAL OFFICES

UPDATE LocalizedText SET Text='+50% к росту для городов, расположенных не на вашем исходном континенте.' WHERE Tag='LOC_POLICY_COLONIAL_OFFICES_DESCRIPTION' ;
...
UPDATE LocalizedText SET Text='[ICON_Production][ICON_RESOURCE_IRON] Пехота 1 (Агогэ)' WHERE Tag='LOC_POLICY_AGOGE_NAME' ;
UPDATE LocalizedText SET Text='[ICON_Production][ICON_RESOURCE_IRON] Пехота 2 (Феодальный договор)' WHERE Tag='LOC_POLICY_FEUDAL_CONTRACT_NAME' ;
UPDATE LocalizedText SET Text='[ICON_Production][ICON_RESOURCE_IRON] Пехота 3 (Великая армия)' WHERE Tag='LOC_POLICY_GRANDE_ARMEE_NAME' ;
UPDATE LocalizedText SET Text='[ICON_Production][ICON_RESOURCE_IRON] Пехота 4 (Армия превыше всего)' WHERE Tag='LOC_POLICY_MILITARY_FIRST_NAME' ;



UPDATE LocalizedText SET Text='[ICON_Production][ICON_RESOURCE_HORSES] Кавалерия 1 (Маневр)' WHERE Tag='LOC_POLICY_MANEUVER_NAME' ;
UPDATE LocalizedText SET Text='[ICON_Production][ICON_RESOURCE_HORSES] Кавалерия 2 (Рыцарство)' WHERE Tag='LOC_POLICY_CHIVALRY_NAME' ;
UPDATE LocalizedText SET Text='[ICON_Production][ICON_RESOURCE_HORSES] Кавалерия 3 (Блицкриг)' WHERE Tag='LOC_POLICY_LIGHTNING_WARFARE_NAME' ;


UPDATE LocalizedText SET Text='[ICON_Production][ICON_RANGED] Авиация 1 (Звездный час)' WHERE Tag='LOC_POLICY_FINEST_HOUR_NAME' ;
UPDATE LocalizedText SET Text='[ICON_Production][ICON_RANGED] Авиация 2 (Стратегические ВВС)' WHERE Tag='LOC_POLICY_STRATEGIC_AIR_FORCE_NAME' ;


UPDATE LocalizedText SET Text='[ICON_Production][ICON_RESOURCE_WHALES] Флот 1 (Морское судоходство)' WHERE Tag='LOC_POLICY_MARITIME_INDUSTRIES_NAME' ;
UPDATE LocalizedText SET Text='[ICON_Production][ICON_RESOURCE_WHALES] Флот 2 (Принудительная вербовка)' WHERE Tag='LOC_POLICY_PRESS_GANGS_NAME' ;
UPDATE LocalizedText SET Text='[ICON_Production][ICON_RESOURCE_WHALES] Флот 3 (Международные воды)' WHERE Tag='LOC_POLICY_INTERNATIONAL_WATERS_NAME' ;


UPDATE LocalizedText SET Text='[ICON_Production][ICON_RESOURCE_WINE] Илкум' WHERE Tag='LOC_POLICY_ILKUM_NAME' ;
UPDATE LocalizedText SET Text='[ICON_RESOURCE_WINE][ICON_RESOURCE_WINE] Крепостное право' WHERE Tag='LOC_POLICY_SERFDOM_NAME' ;
UPDATE LocalizedText SET Text='[ICON_Production][ICON_RESOURCE_WINE][ICON_RESOURCE_WINE] Общественные работы' WHERE Tag='LOC_POLICY_PUBLIC_WORKS_NAME' ;



UPDATE LocalizedText SET Text='+30% к [ICON_PRODUCTION] производству юнитов ближнего и дальнего боя вплоть до конца эпохи Античности.' WHERE Tag='LOC_POLICY_AGOGE_DESCRIPTION' ;
UPDATE LocalizedText SET Text='+40% к [ICON_PRODUCTION] производству юнитов ближнего и дальнего боя вплоть до конца эпохи Возрождения.' WHERE Tag='LOC_POLICY_FEUDAL_CONTRACT_DESCRIPTION' ;
UPDATE LocalizedText SET Text='+50% к [ICON_PRODUCTION] производству юнитов ближнего и дальнего боя вплоть до конца эпохи Нового времени.' WHERE Tag='LOC_POLICY_GRANDE_ARMEE_DESCRIPTION' ;
UPDATE LocalizedText SET Text='+50% к [ICON_PRODUCTION] производству юнитов ближнего и дальнего боя любой эпохи.' WHERE Tag='LOC_POLICY_MILITARY_FIRST_DESCRIPTION' ;

UPDATE LocalizedText SET Text='+30% к [ICON_PRODUCTION] производству кавалерийских юнитов вплоть до конца эпохи Античности.' WHERE Tag='LOC_POLICY_MANEUVER_DESCRIPTION' ;
UPDATE LocalizedText SET Text='+40% к [ICON_PRODUCTION] производству кавалерийских юнитов вплоть до конца Промышленной эры.' WHERE Tag='LOC_POLICY_CHIVALRY_DESCRIPTION' ;
UPDATE LocalizedText SET Text='+50% к [ICON_PRODUCTION] производству всех кавалерийских юнитов.' WHERE Tag='LOC_POLICY_LIGHTNING_WARFARE_DESCRIPTION' ;


UPDATE LocalizedText SET Text='+100% к [ICON_PRODUCTION] производству военно-морских юнитов вплоть до конца эпохи Античности.' WHERE Tag='LOC_POLICY_MARITIME_INDUSTRIES_DESCRIPTION' ;
UPDATE LocalizedText SET Text='+100% к [ICON_PRODUCTION] производству военно-морских юнитов вплоть до конца Промышленной эры.' WHERE Tag='LOC_POLICY_PRESS_GANGS_DESCRIPTION' ;
UPDATE LocalizedText SET Text='+100% к [ICON_PRODUCTION] производству всех военно-морских юнитов кроме авианосцев и ракетных крейсеров.' WHERE Tag='LOC_POLICY_INTERNATIONAL_WATERS_DESCRIPTION' ;
...
-- support
UPDATE LocalizedText SET Text='[ICON_Production][ICON_RESOURCE_MERCURY]Отечественная война' WHERE Tag='LOC_POLICY_PATRIOTIC_WAR_NAME' ;
...
-- settlers
UPDATE LocalizedText SET Text='[ICON_PRODUCTION][ICON_RESOURCE_TEA] ' || Text  WHERE Tag='LOC_POLICY_COLONIZATION_NAME' ;
...
UPDATE LocalizedText SET Text='[ICON_BOLT][ICON_SCIENCE] Рационализм' WHERE Tag='LOC_POLICY_RATIONALISM_NAME' ;
UPDATE LocalizedText SET Text='[ICON_BOLT][ICON_FAITH] Колониальные налоги' WHERE Tag='LOC_POLICY_SIMULTANEUM_NAME' ;
...
UPDATE LocalizedText SET Text='+1 [ICON_Gold] за каждый стратегический или редкий ресурс поставляемый для международной [ICON_TRADEroute] торговли. +2 [ICON_Culture] и +2 [ICON_Science]. ' WHERE Tag='LOC_POLICY_MARKET_ECONOMY_DESCRIPTION' ;
